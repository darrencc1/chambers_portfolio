...
_This is the XGboost top 20 that I am using._
...
# Evaluating the model with the accuracy score using Top 10 Features
accuracy_score_filtered = accuracy_score(y_test, y_pred_filtered)
print("RandomForest Accuracy with Top 20 Features 34/64:", accuracy_score_filtered)
```
...
# Evaluating the model with the accuracy score using Top 10 Features
accuracy_score_filtered = accuracy_score(y_test, y_pred_filtered)
print("DecisionTreeClassifier Accuracy with Top 20 Features 34/64:", accuracy_score_filtered)
```
