...
_Looking at Random Forest, Decision Tree and XGboost the highest accuracy rate was xgboost at 93.1% using 20/80._
...
_Below I will show you some different results based on test size and 3 different Algorithms. These algorithms are RandomForest, Decision Tree and XGboost. This first test size is 34 and random state 66. For all of these I used the top 20 features and for XGboost I found using an n_estimator = 500 to get the best results. _
...
True positive, false Positive explain and what they mean
One is precision on is recall. 
