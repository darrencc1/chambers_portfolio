...
_Looking at the chart we see that almost 25% was from one-story buildings. After this the effectivness of the potential relationships drop drastically. After applying different amounts of these metrics I found that only using the top 20 increased the accuracy of the algorithms._
...
_For this set I am using the 80/20 test and with this the accuracy went back up reaching 92.45% this dropped to 92.34% When using on;y the top 10. for the random Tree algorithm which is the highest of all the tests so far._
