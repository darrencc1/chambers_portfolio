...
_This Chart shows the relationship between average player salary and % home runs. I wanted to show not just PHA and NYA but the top ten results as well._
```{python}
